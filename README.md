Using XGboost to build a similar model to the Pytorch one on the same music metadata dataset yields results of 93% (!) accuracy at prediction TV show placements based upon metadata alone.
